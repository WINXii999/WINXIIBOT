  ...
  for (const nk of callUpdate) {
    if (nk.isGroup == false) {
      if (nk.status == 'offer') {
        ...
        const vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;💗WINXII BOT💗;;;\nFN:💗WINXII BOT💗\nORG:💗WINXII BOT💗\nTITLE:\nitem1.TEL;waid=5217223931652:5217223931652\nitem1.X-ABLabel:💗WINXII BOT💗\nX-WA-BIZ-DESCRIPTION:[❗] ᴄᴏɴᴛᴀᴄᴛᴀ ᴀ ᴇsᴛᴇ ɴᴜᴍ ᴘᴀʀᴀ ᴄᴏsᴀs ɪᴍᴘᴏʀᴛᴀɴᴛᴇs.\nX-WA-BIZ-NAME:💗WINXII BOT💗\nEND:VCARD`;
        await mconn.conn.sendMessage(nk.from, {contacts: {displayName: '💗WINXII BOT💗', contacts: [{vcard}]}}, {quoted: callmsg});
